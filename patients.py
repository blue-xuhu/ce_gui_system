...
######################################################
        ...
        if '@' not in email:
            ...
            if password != confirmPass:
                ...
                if len(phone) != 11:
                    ...
                    print(sex)
                    c.execute("INSERT INTO NEWBANK(USERNAME, FIRSTNAME, LASTNAME, EMAIL, PASSWORD, CONFIRM, PHONE, SEX ,ADDRESS)VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s')"%(str(username), str(firstname), str(lastname), str(email), str(password), str(confirmPass), str(phone), str(sex), str(address)))
                    print('insert done')
                    dbb.commit()
                    dbb.close()
                    self.login()
    ...
    def retranslateUi(self, registrationPage):
        ...
        registrationPage.setWindowTitle(_translate("registrationPage", "病例表"))
        self.label_username.setText(_translate("registrationPage", "姓名"))
        self.lineEdit_Username.setPlaceholderText(_translate("registrationPage", "姓名"))
        self.label_fname.setText(_translate("registrationPage", "姓氏"))
        self.lineEdit_Firstname.setPlaceholderText(_translate("registrationPage", "姓氏"))
        self.label_Lname.setText(_translate("registrationPage", "名字"))
        self.lineEdit_Lastname.setPlaceholderText(_translate("registrationPage", "名字"))
        self.label_email.setText(_translate("registrationPage", "邮箱"))
        self.lineEdit_email.setPlaceholderText(_translate("registrationPage", "邮箱"))
        ...
        self.label_phone.setText(_translate("registrationPage", "电话"))
        self.lineEdit_phone.setPlaceholderText(_translate("registrationPage", "电话"))
        self.label_sex.setText(_translate("registrationPage", "性别"))
        self.lineEdit_sex.setPlaceholderText(_translate("registrationPage", "性别"))
        self.label_address.setText(_translate("registrationPage", "地址"))
        self.lineEdit_address.setPlaceholderText(_translate("registrationPage", "地址"))
        self.pushButton_Register.setText(_translate("registrationPage", "保存"))
        # self.pushButton_reglogin.setText(_translate("registrationPage", "LOGIN"))
        self.label_10.setText(_translate("registrationPage", "患者档案"))
